...
```date
[root@host8469 ~]# date
Thu Jul 13 01:01:57 CST 2017
[root@host8469 ~]# docker run -it python:2.7.13 bash
root@7bdf6b5865f3:/# date
Web Jul 12 17:02:03 UTC 2017
```
...
```date
[root@host8469 ~]# date
Thu Jul 13 01:01:10 CST 2017
[root@host8469 ~]# docker run -it python:2.7.13 bash
root@b0b2337cae2:/# date
Thu Jul 13 01:01:38 CST 2017
```
...
docker run -d -p 5000:5000 --restart=always --name registry-v2 -v /opt/data/registry-v2:/var/lib/registry registry:2.5.1
```
